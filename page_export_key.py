...
class ExportKeyPage:
    ...
    def show_private_key(self, e):
        ...
        try:
            # Export private key
            exported = self.app.wallet_core.export_wallet()
            if exported and exported.get('private_key'):
                self.private_key_display.value = exported['private_key']
                ...
                self.app.show_snackbar("❌ Failed to export private key", "error")
